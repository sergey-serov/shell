...
check_address '/404.html' 200
check_address '/.another-must-denied' 403
check_address '/deny' 200
check_address '/index.html' 200
check_address '/index.php' 200
check_address '/.must-be-denyed.php' 403
check_address '/must-redirect.php' 403
check_address '/sprites.png' 200
check_address '/static-file.txt' 200
check_address '/another-no-such-file.php' 403
